...
def voigt_absorption_line_new(
        wavegrid, lambda0=0.0, f=0.0, gamma=0.0,B_vary = None, b=0.0, N=0.0, v_rad=0.0, v_resolution=0.0, n_step=25, composition=None, map=map, debug=False
):
    """
    ...
    Args:
        ...
        b (float64): The b parameter (Gaussian width), in km/s (numpy array, number of b values depends on user, if the user want to 
        to vary all the b values then "B_vary = True" then there will be "n" number of b elements or else if "B_vary = False" then there 
        will be 1 b element overall)
